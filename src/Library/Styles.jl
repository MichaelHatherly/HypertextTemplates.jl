...
export SIZES, COLORS, SPACING, RADIUS, TRANSITIONS, SHADOWS,
       get_size_classes, get_color_classes, get_transition_classes,
       get_focus_classes, get_disabled_classes
...
function get_focus_classes(color::Symbol=:primary, enhanced::Bool=true)
    ...
    if enhanced
        return base_focus * " focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-slate-900"
    end
